...
/*minhnt31 add define callback encrypt/decrypt function*/
typedef pj_status_t(* vt_pjmedia_send_udp_cb) (char *in_data, pj_ssize_t *in_size,char *out_data, pj_ssize_t *out_size);
typedef pj_status_t(* vt_pjmedia_receive_udp_cb) (char *in_data, pj_ssize_t *in_size,char *out_data, pj_ssize_t *out_size,pj_status_t previous_status);
...
/*minhnt31 add static function to add callback*/
PJ_DECL(pj_status_t) vt_set_cb_udp_pjmedia(vt_pjmedia_send_udp_cb send_function,vt_pjmedia_receive_udp_cb receive_function);
